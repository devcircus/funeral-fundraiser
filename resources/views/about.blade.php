    ...
    <div class="stripe p-12 xl:p-20">
        <div class="stripe__content flex flex-col lg:flex-row justify-between">
            <div class="w-full lg:w-1/4 mr-4">
                <img src="https://res.cloudinary.com/phpstage/image/upload/f_auto,e_auto_contrast,r_0,w_auto,q_auto/v1551147038/img/Photo_Mar_10_3_05_06_PM" class="w-3/5 lg:w-full rounded-full shadow-md border-2 border-white lg:mr-0" />
            </div>
